...
public class TickStockTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));

    public static TickStock getTickStockSample1() {
        return new TickStock()
            .id(1L)
    ...
    public static TickStock getTickStockSample2() {
        return new TickStock()
            .id(2L)
    ...
    public static TickStock getTickStockRandomSampleGenerator() {
        return new TickStock()
